<?php
/* -------------------------------------------------------------------------- *\
|* -[ moule-diary - Training Export_list ]---------------------------------------- *|
\* -------------------------------------------------------------------------- */
...
if(isset($_SESSION['filters']["module-diary_list.php"])){$_GET=array_merge($_SESSION['filters']["module-diary_list.php"],$_GET);}

global $trainings;
$trainings=api_moduleDiary_trainings();
